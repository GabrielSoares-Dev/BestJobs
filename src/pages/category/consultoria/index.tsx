...
import { Consultorias } from '../../../datafake/consultoria';
import { Pagination } from 'antd';
import * as Styled from '../styles';


const PageCategoryConsultoria: React.FC = () => {
            ...
            <Grid
                ...
                <Grid marginLeft={5} item>
                    <Breadcrumbs aria-label="breadcrumb">
                        ...
                        <Styled.LinkCustom to='/'>Consultorias</Styled.LinkCustom>
                    </Breadcrumbs>
                </Grid>
                <Grid
                    marginLeft={5}
                    item
                >
                    <Styled.Title>Consultorias</Styled.Title>
                </Grid>
                <Grid
                    gap={3}
                    alignItems='center'
...
export default PageCategoryConsultoria;
